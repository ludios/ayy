 ...
 */
declare function is<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function nis<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function eq<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function neq<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function lt<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function lte<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function gt<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
/**
 ...
 * @param extraMessageOrFn string to append to the assertion error, or a 0-arg callable that returns such a string
 */
declare function gte<T>(a: T, b: T, extraMessageOrFn?: MessageOrFn): void;
